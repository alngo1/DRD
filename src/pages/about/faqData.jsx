...
export default [
    {
        ...
        answer: <div className="answer">
                    ...
                    <p className="body-text-two-font"><span>Rowing (crew)</span></p>
                    <ul className="body-text-two-font">
                        <li>Use Oars</li>
                        <li>Legs + core</li>
    ...
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>No</span>, we accept all levels of experience. If you have no experience with dragon boat, we’ll teach you the basics at your first practice!</p>
        </div>,
        expanded: false
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>Yes</span>, we provide carpool to every practice, and some socials. If you help with carpool, you will be reimbursed for gas money (and we&#39;ll be infinitely grateful &lt;3)."</p>
        </div>,
        expanded: false
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>No</span>, you can come to as many or as little events as you want/are able to. No pressure!</p>
        </div>,
        expanded: false
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>What to wear</span></p>
            <ul className="body-text-two-font">
                <li>Athletic attire</li>
                <li>Sandals</li>
                <li>Hat</li>
            </ul>
            <p className="body-text-two-font"><span>What to bring</span></p>
            <ul className="body-text-two-font">
                <li>Water</li>
                <li>Sunblock</li>
                <li>Towel</li>
    ...
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>No</span>, it is very rare for us to be put in a situation where we would need to know how to swim. We also wear personal flotation devices (PFDs) for extra safety!</p>
            <p className="body-text-two-font">P.S. Lots of our members don’t know how to swim lol.</p>
        </div>,
        expanded: false
    },
    {
    ...
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>Yes</span>, after your first 30 days of free membership, there are a few fees to pay if you decide to stick with the team!</p>
            <p className="body-text-two-font">Team fees are $15-20 per quarter, and California Dragon Boat Association fees are $80 per year for college students.</p>
            <p className="body-text-two-font"><span>Team Fees</span></p>
            <ul className="body-text-two-font">
                <li>Fall Quarter: $20 </li>
                <li>Winter Quarter: $15</li>
                <li>Spring Quarter: $20 </li>
            </ul>
            <p className="body-text-two-font">We split each quarter into separate payment windows to give our members flexibility with when they want to be active.</p>
    ...
    },
    {
        ...
        spanIndex: 1,
        answer: <div className="answer">
            <p className="body-text-two-font"><span>No</span>, we accept all levels of athleticism! Don’t be shy to join if you have little experience with exercising, we&#39;ll be sure to train you to meet whatever goals you have.</p>
        </div>,
        expanded: false
    }
]