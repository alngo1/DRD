...
### git
So you've added your file to the assets folder. You've linked your asset to your desired location. How can you see your changes locally at home? Can you create a preview site with a shareable link? How do you deploy to the actual website?

## See Changes Locally
https://docs.netlify.com/api-and-cli-guides/cli-guides/local-development/

## Create Live Preview Site
Using github desktop:
- if your branch is not currently dev, click the dropdown for Current Branch and Switch to dev.
- Add your changes.
- write your commit message then near top left there should be an button to push to dev.
- check github to create a pull request. give it a second to create previews
- review the site changes from the link that gets generated by netlify
- once you feel ready you can merge those changes to main to deploy.

Using git cli:
- switch to dev
  - git checkout dev
- add your changes, then enter the following:
  - git add .
  - git commit -m "enter your commit message in these quotes"
  - git push origin dev

- then navigate to github on your browser
- create a pull request for dev which will generate a preview. you should then be able to see the link

## Deploying to Actual Site
Using github desktop:
- write your commit message then near top left there should be an option to push to ma just click that

Using git cli:
- After you add your changes, enter in the following commands:
    - git add .
    - git commit -m "enter your commit message in these quotes"
    - git push origin
